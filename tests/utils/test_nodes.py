...
from agent.utils.state import AppState, create_app_state, create_tool_result, Action, create_action
...
def test_geocode_node_handles_no_action():
...
def test_weather_node_success_and_updates_state_correctly(mocker):
    ...
    initial_state: AppState = create_app_state(
        ...
        action=Action(tool="weather", tool_input={"location_name": "台南"}),
